...
export class WorkflowEngine {
  ...
  async executeCommand(
    ...
    try {
      ...
      // 2. Komut işleme
      // Line 159 - Fix createCommandProcessor call
      const processor = createCommandProcessor(moduleController) // Pass ModuleController instance
      
      // Line 160 - Fix processCommand call
      const result = await processor.processCommand(
        { type: command, parameters: {} }, // Command object
        { userId, sessionId: 'workflow' }   // CommandContext object
      )
