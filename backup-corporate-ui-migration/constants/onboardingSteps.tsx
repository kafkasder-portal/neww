      ...
      <div className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center space-x-3 p-3 corporate-table-header rounded-lg">
    ...
    content: (
      <div className="space-y-4">
        <div className="corporate-table-header p-4 rounded-lg">
          ...
          <ul className="corporate-form-group text-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-3">
            ...
            <div className="corporate-form-group">
              ...
              <div className="flex items-center justify-between p-2 corporate-table-header rounded">
