  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="relative p-2 corporate-btn-ghost rounded-lg transition-colors"
      >
              ...
              <div className="divide-y divide-gray-100">
                {notifications.map((notification) => (
                  <div
                    ...
                    className={`p-4 cursor-pointer hover:corporate-table-header transition-colors border-l-4 ${
