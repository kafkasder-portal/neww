          ...
          {loading ? (
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white border rounded-lg p-4">
                ...
                <div className="corporate-form-group">
                  {analytics.mostUsedCommands.map((cmd: any, index: number) => (
                    <div key={index} className="flex items-center justify-between p-3 corporate-table-header rounded">
              ...
              <div className="bg-white border rounded-lg p-4">
                ...
                <div className="corporate-form-group max-h-64 overflow-y-auto">
