  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <CorporateCard className="w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
          ...
          {filteredHistory.length === 0 ? (
            ...
            <div className="space-y-3">
              {filteredHistory.map((item) => (
                <div
                  key={item.id}
                  className="border rounded-lg p-4 hover:corporate-table-header transition-colors"
                >
                    ...
                    <div className="flex-1">
                      ...
                      {item.response && (
                        <div>
                          ...
                          <p className="text-sm text-gray-600 corporate-table-header p-2 rounded max-h-20 overflow-y-auto">
                            {item.response}
                          </p>
                        </div>
                      )}
        ...
        {/* Footer */}
        <div className="p-6 border-t corporate-table-header">
