    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <CorporateCard className="w-full max-w-6xl max-h-[90vh] overflow-hidden bg-white shadow-2xl">
        ...
        <div className="flex h-[calc(90vh-120px)]">
          {/* Sidebar - Categories */}
          <div className="w-64 border-r corporate-table-header p-4">
            ...
            <div className="corporate-form-group">
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <CorporateBadge variant="neutral" className="ml-auto">
                    {widgets.length}
                  </CorporateBadge>
                </div>
              </button>
                ...
                <div
                  ...
                  className={`p-4 border rounded-lg cursor-move transition-all ${
                    ...
                    widget.enabled 
                      ...
                      : 'corporate-table-header border-gray-200 opacity-60'
                  }`}
                >
