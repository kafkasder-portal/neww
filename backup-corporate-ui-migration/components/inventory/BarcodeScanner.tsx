        ...
        <div className="space-y-4">
          ...
          {scanMode === 'camera' && (
            <>
              ...
              {/* Kamera Yok */}
              {!hasCamera && (
                <div className="text-center py-8 corporate-table-header rounded-lg">
                  <Camera className="w-12 h-12 mx-auto text-gray-400 mb-4" />
                  <p className="text-gray-600 mb-4">Kamera erişimi sağlanamadı</p>
                  <CorporateButton onClick={() => window.location.reload()} variant="neutral">
                    Sayfayı Yenile
                  </CorporateButton>
                </div>
              )}
                  ...
                  {!isScanning ? (
                    ...
                    <>
                      ...
                      {cameraDevices.length > 1 && (
                        <CorporateButton onClick={switchCamera} variant="neutral" className="flex items-center gap-2">
          ...
          {scanMode === 'manual' && (
            <div className="space-y-4">
              <div className="text-center py-4 corporate-table-header rounded-lg">
