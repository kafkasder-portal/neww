...
export default function UserStatistics({ statistics }: UserStatisticsProps) {
  const roleColors: Record<UserRole, string> = {
    ...
    viewer: 'text-gray-600 corporate-table-header border-gray-200'
  }
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        ...
        <div className="corporate-grid-2">
          <div>
            <h4 className="corporate-form-label mb-2">Kullanıcı Durumu</h4>
          ...
          <div>
            <h4 className="corporate-form-label mb-2">Yetki Dağılımı</h4>
            <div className="corporate-form-group">
              <div className="flex justify-between">
