...
export default function RoleChangeModal({ 
  ...
  const getRoleColor = (role: UserRole): string => {
    const colors = {
      ...
      viewer: 'border-gray-300 corporate-table-header text-gray-800'
    }
    return colors[role] || 'border-gray-300 corporate-table-header text-gray-800'
  }
    ...
    <Modal isOpen={isOpen} onClose={handleClose}>
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          {/* User Info */}
          <div className="corporate-table-header rounded-lg p-4">
            <div className="flex items-center">
          ...
          {/* Role Selection */}
          <div>
            <label className="block corporate-form-label mb-3">
              Yeni Rol Seçin
            </label>
            <div className="space-y-3">
              {roles.map((role) => (
                <label
                  key={role}
                  className={`relative flex cursor-pointer rounded-lg border p-4 hover:corporate-table-header ${
          ...
          {/* Reason */}
          <div>
            <label htmlFor="reason" className="block corporate-form-label mb-2">
            ...
            <textarea
              ...
              className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:corporate-table-header disabled:cursor-not-allowed"
            />
          ...
          <div className="flex items-center justify-end space-x-3 pt-4 border-t border-gray-200">
            <button
              ...
              onClick={handleClose}
              disabled={isSubmitting}
              className="px-4 py-2 corporate-form-label bg-white border border-gray-300 rounded-md hover:corporate-table-header disabled:cursor-not-allowed disabled:opacity-50"
            >
              İptal
            </button>
            <button
