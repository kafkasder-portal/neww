    ...
    <Modal isOpen={isOpen} onClose={handleClose}>
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          {/* Full Name */}
          <div>
            <label htmlFor="full_name" className="block corporate-form-label mb-1">
              Ad Soyad *
            </label>
            <div className="relative">
              ...
              <input
                ...
                disabled={isSubmitting}
                required
                className="pl-10 w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:corporate-table-header disabled:cursor-not-allowed"
          ...
          {/* Email */}
          <div>
            <label htmlFor="email" className="block corporate-form-label mb-1">
              E-posta *
            </label>
            <div className="relative">
          ...
          {/* Department */}
          <div>
            <label htmlFor="department" className="block corporate-form-label mb-1">
              Departman
            </label>
            <div className="relative">
          ...
          {/* Phone */}
          <div>
            <label htmlFor="phone" className="block corporate-form-label mb-1">
              Telefon
            </label>
            <div className="relative">
