    ...
    <div className={`relative ${className}`} ref={dropdownRef}>
      ...
      {isOpen && (
        <CorporateCard className="absolute right-0 top-12 w-96 max-h-96 overflow-hidden shadow-lg border z-50">
          {/* Header */}
          <div className="p-4 border-b corporate-table-header">
            ...
            {loading ? (
              ...
              <div className="divide-y">
                {notifications.map((notification) => (
                  <div
                    key={notification.id}
                    className={`p-4 hover:corporate-table-header cursor-pointer transition-colors ${
          ...
          {/* Footer */}
          {notifications.length > 0 && (
            <div className="p-3 border-t corporate-table-header">
              <CorporateButton
                variant="ghost"
                size="sm"
