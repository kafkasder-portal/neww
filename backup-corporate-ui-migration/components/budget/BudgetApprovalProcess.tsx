        ...
        <CorporateCardHeader>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <CorporateButton onClick={exportApprovalReport} size="sm" variant="neutral">
              ...
              <CorporateCard key={step.id} className={`${step.status === 'pending' ? 'border-yellow-200 bg-yellow-50' : ''
                ...
                <CorporateCardContent className="pt-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1 corporate-form-group">
                      <div className="flex items-center justify-between">
                        <div>
                      ...
                      {step.comments && (
                        <div className="corporate-table-header p-3 rounded-md">
            ...
            <CorporateCardContent>
              <div className="space-y-3">
                {budget.categories.map((category) => (
                  <div key={category.id} className="flex items-center justify-between p-3 corporate-table-header rounded-md">
                    <div>
