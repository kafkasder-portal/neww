          ...
          <CorporateCardContent>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <CorporateBadge variant="neutral" className="text-green-600">
              ...
              <div className="flex items-center justify-between">
                ...
                <CorporateBadge variant="neutral" className="text-red-600">
              ...
              <div className="flex items-center justify-between">
                ...
                <CorporateBadge variant="neutral" className="text-blue-600">
        ...
        <CorporateCardHeader>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <CorporateButton onClick={exportData} size="sm" variant="neutral">
