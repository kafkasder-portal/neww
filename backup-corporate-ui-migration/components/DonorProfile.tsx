    ...
    <div className={`bg-white rounded-xl shadow-lg border border-gray-200 ${className}`}>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="corporate-table-header rounded-lg p-6">
          ...
          <div className="corporate-table-header rounded-lg p-6">
            ...
            <div className="space-y-4">
              <div>
                <label className="corporate-form-label mb-2 block">Tercih Edilen Yöntem</label>
                {isEditing ? (
                  <select
              ...
              <div>
                <label className="corporate-form-label mb-2 block">Notlar</label>
                {isEditing ? (
                  <textarea
