      ...
      <CorporateCard className="p-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center space-x-3">
            ...
            <CorporateBadge variant="neutral">{locations.length} Lokasyon</CorporateBadge>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <CorporateCard className="p-4">
            ...
            <div className="corporate-form-group max-h-96 overflow-y-auto">
              {filteredLocations.map((location) => (
                <div
                  key={location.id}
                  className="p-3 border rounded-lg hover:corporate-table-header cursor-pointer"
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="details" className="space-y-4">
          {selectedLocation ? (
            ...
            <CorporateCard className="p-6 text-center">
