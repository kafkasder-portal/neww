        ...
        <div className="flex items-center justify-center min-h-[400px] p-4">
          <CorporateCard className="w-full max-w-lg p-8 text-center">
            <div className="mb-6">
              ...
              {errorId && (
                <div className="corporate-table-header rounded-lg p-3 mb-4">
            ...
            {showDetails && error && (
              <div className="mb-6 text-left">
                <details className="corporate-table-header rounded-lg p-4">
                  <summary className="cursor-pointer font-medium text-gray-700 mb-2">
                    Teknik Detaylar
                  </summary>
                  <div className="text-sm text-gray-600 corporate-form-group">
                    <div>
