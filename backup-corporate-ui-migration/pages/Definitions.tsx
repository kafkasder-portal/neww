  ...
  return (
    <div className="p-6">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Quick Access Cards */}
        <div className="corporate-grid-4 mb-8">
        ...
        <div className="corporate-grid-3 mb-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow">
          ...
          <div className="p-6">
            <div className="space-y-4">
              <div className="flex items-center gap-3 p-4 corporate-table-header dark:bg-gray-800 rounded-lg">
