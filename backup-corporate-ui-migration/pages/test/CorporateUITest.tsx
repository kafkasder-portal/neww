...
const CorporateUITest: React.FC = () => {
    ...
    return (
        <div className="corporate-container p-6 space-y-6">
            <div className="corporate-header">
                <h1 className="corporate-title">Kurumsal UI Test Sayfası</h1>
                <p className="corporate-subtitle">Tüm kurumsal bileşenlerin test edildiği sayfa</p>
            </div>
            ...
            <CorporateCard>
                ...
                <CorporateCardContent>
                    <div className="corporate-grid-2 gap-4">
            ...
            <CorporateCard>
                ...
                <CorporateCardContent>
                    <div className="space-x-4">
                        ...
                        <CorporateBadge variant="neutral">Neutral</CorporateBadge>
                    </div>
                </CorporateCardContent>
            </CorporateCard>
