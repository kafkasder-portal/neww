      ...
      <div className="bg-card border border-border shadow-sm rounded-lg max-w-7xl mx-auto overflow-hidden">
        <header className="px-4 py-3 bg-gradient-to-r from-green-600 to-green-700 text-white text-sm font-medium flex items-center justify-between">
          ...
          <div className="flex space-x-2">
            ...
            <button className="px-3 py-1 corporate-table-header0 hover:bg-gray-400 rounded text-xs transition-colors">
              İptal
            </button>
          </div>
        </header>
        ...
        <div className="flex">
            ...
            <div className="grid grid-cols-4 gap-6 text-sm">
              ...
              <div className="col-span-1">
                <div className="relative">
                  <div className="border-2 border-dashed border-gray-300 h-32 w-full corporate-table-header rounded-lg mb-3 flex items-center justify-center hover:border-gray-400 transition-colors cursor-pointer group">
                ...
                <div className="space-y-3">
                  <div>
                    <label className="block corporate-form-label mb-2">Sponsorluk Tipi</label>
                    <select
                      value={sponsorType}
              ...
              <div className="col-span-1 space-y-4">
                <div>
                  <label className="block corporate-form-label mb-2">Ad</label>
                  <input
                    type="text"
                    value={name}
                ...
                <div>
                  <label className="block corporate-form-label mb-2">Soyad</label>
                  <input
                    type="text"
                    value={surname}
                ...
                <div>
                  <label className="block corporate-form-label mb-2">Uyruk</label>
                  <div className="flex rounded-md shadow-sm">
                    <input
                      type="text"
                      value={nationality}
                      readOnly
                      className="flex-1 text-sm border border-gray-300 rounded-l-md px-3 py-2 corporate-table-header text-gray-500"
                    />
                    <button className="px-3 border border-l-0 border-gray-300 rounded-r-md corporate-table-header hover:bg-gray-100 text-gray-500 hover:text-gray-700 transition-colors">
                ...
                <div className="corporate-form-group">
                  <div>
                    <label className="block corporate-form-label mb-2">Kimlik No</label>
                    <input
                      type="text"
                      value={identityNo}
                ...
                <div>
                  <label className="block corporate-form-label mb-2">Kategori</label>
                  <select
                    value={category}
                ...
                <div>
                  <label className="block corporate-form-label mb-2">Fon Bölgesi</label>
                  <select
                    value={fundRegion}
                ...
                <div>
                  <label className="block corporate-form-label mb-2">Dosya Bağlantısı</label>
                  <select
                    value={fileRelation}
                ...
                <div>
                  <label className="block corporate-form-label mb-2">Dosya Numarası</label>
                  <div className="flex space-x-2">
                    <input
                      type="text"
                      readOnly
                      className="w-16 text-sm border border-gray-300 rounded-md px-3 py-2 corporate-table-header text-gray-500"
                      placeholder="Auto"
                    />
                    <input
                      type="text"
              ...
              <div className="col-span-1 corporate-form-group">
                <div>
          ...
          <div className="w-80 border-l border-gray-200 corporate-table-header p-4">
                  ...
                  <button
                    ...
                    className={`h-14 text-xs border rounded-md text-center transition-all duration-200 hover:shadow-sm ${
                      activeRecordType === 'bank-accounts'
                        ...
                        : 'bg-white border-gray-200 hover:corporate-table-header hover:border-gray-300'
                    }`}
                  >
                    ���� Banka Hesapları
                  </button>
