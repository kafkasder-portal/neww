    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-4 rounded-lg border p-4">
        ...
        <div className="flex items-center gap-1">
          <button
            onClick={() => exportToCsv('yardim-basvurulari.csv', filteredApplications)}
          ...
          <button
            onClick={() => {
              ...
              exportApplicationsToExcel(filteredApplications as unknown as Record<string, unknown>[], Object.values(filters).some(v => v) ? filters : undefined)
            }}
          ...
          <button
            onClick={() => {
              ...
              exportApplicationsToPDF(filteredApplications as unknown as Record<string, unknown>[], Object.values(filters).some(v => v) ? filters : undefined)
            }}
      ...
      <Modal open={showEvaluationModal} onClose={() => setShowEvaluationModal(false)}>
        ...
        {evaluatingApplication && (
          <div className="p-4 space-y-4">
            <div className="rounded border p-4 corporate-table-header">
              <h3 className="font-medium mb-2">Başvuru Detayları</h3>
              <div className="corporate-form-group text-sm">
