...
// const ChartLoading = () => (
//   <div className="flex items-center justify-center h-64 corporate-table-header rounded-lg">
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-2">
          <CorporateButton variant="neutral" onClick={exportToCSV}>
            <Download className="h-4 w-4 mr-2" />
            CSV
          </CorporateButton>
          <CorporateButton variant="neutral" onClick={exportToPDF}>
            <Download className="h-4 w-4 mr-2" />
            PDF
          </CorporateButton>
        </div>
