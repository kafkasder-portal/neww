  ...
  const FormSection = ({ title, isExpanded, onToggle, children }: {
    ...
    <div className="border border-gray-200 rounded-lg mb-4">
      <button
        type="button"
        onClick={onToggle}
        className="w-full px-4 py-3 corporate-table-header hover:bg-gray-100 flex items-center justify-between text-left font-medium text-gray-900 rounded-t-lg"
      >
        <span>{title}</span>
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="flex justify-end gap-2 pt-4 border-t">
            ...
            <button 
              onClick={handleSave}
              disabled={saving}
              className="corporate-btn-success disabled:opacity-50"
            >
