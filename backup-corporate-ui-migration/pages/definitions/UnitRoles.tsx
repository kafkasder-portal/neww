  ...
  return (
    <div className="p-6">
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="p-4 border-b border-gray-200 corporate-table-header">
          ...
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {paginatedRoles.map((role) => (
                <tr key={role.id} className="hover:corporate-table-header">
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
        <div className="p-6">
          ...
          <div className="space-y-4">
            <div>
              <label className="block corporate-form-label mb-2">
                Rol Adı
              </label>
              <input
                type="text"
          ...
          <div className="flex gap-3 mt-6">
            <button
              ...
              className="flex-1 px-4 py-2 corporate-form-label bg-white border border-gray-300 rounded-lg hover:corporate-table-header"
            >
              İptal
            </button>
            <button
