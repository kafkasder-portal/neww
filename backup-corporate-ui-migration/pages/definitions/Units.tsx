      ...
      <div className="bg-white rounded-lg shadow">
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="corporate-table-header dark:bg-gray-800">
              <tr>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredUnits.map((unit) => (
                <tr key={unit.id} className="hover:corporate-table-header dark:hover:bg-gray-700">
        ...
        <div className="p-6">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block corporate-form-label dark:text-gray-300 mb-2">
                  Birim Adı
                </label>
                <input
                  type="text"
          ...
          <div className="flex gap-3 mt-6">
            <button
              ...
              className="flex-1 px-4 py-2 corporate-form-label dark:text-gray-300 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg hover:corporate-table-header dark:hover:bg-gray-700"
            >
              İptal
            </button>
            <button
