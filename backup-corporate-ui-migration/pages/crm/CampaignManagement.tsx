        ...
        <div className="space-y-4">
          {campaigns
            ...
            .map(campaign => {
              const progress = calculateProgress(campaign.raisedAmount || 0, campaign.targetAmount || 1)
              return (
                <div key={campaign.id} className="flex items-center justify-between p-3 corporate-table-header rounded-lg">
                  <div className="flex items-center space-x-3">
      ...
      <CorporateCard className="p-6">
        ...
        <div className="space-y-4">
          {campaigns
            ...
            .slice(0, 5)
            .map(campaign => (
              <div key={campaign.id} className="flex items-center space-x-3 p-3 corporate-table-header rounded-lg">
                <div className={`flex items-center justify-center w-8 h-8 rounded-lg ${getTypeColor(campaign.campaignType)}`}>
                  {getTypeIcon(campaign.campaignType)}
                </div>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <CorporateButton variant="neutral" onClick={() => DonorCRMService.exportCampaigns()}>
      ...
      {activeTab === 'campaigns' && (
        <>
          ...
          <CorporateCard className="p-4">
            ...
            {showFilters && (
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 p-4 corporate-table-header rounded-lg">
                <div>
      ...
      {showDetailModal && selectedCampaign && (
        ...
        >
          <div className="p-6 space-y-6">
            ...
            {/* Progress Section */}
            <div className="corporate-table-header p-6 rounded-lg">
