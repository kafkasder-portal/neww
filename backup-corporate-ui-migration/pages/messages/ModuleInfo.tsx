    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-lg border">
        ...
        <div className="mt-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="corporate-form-label">Sistem Sağlığı:</span>
        ...
        {selectedFeature && (
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block corporate-form-label mb-1">Sürüm</label>
                <p className="text-sm text-gray-900">v{selectedFeature.version}</p>
              </div>
              <div>
                <label className="block corporate-form-label mb-1">Son Güncelleme</label>
                <p className="text-sm text-gray-900">{selectedFeature.lastUpdate}</p>
              </div>
            </div>

            <div>
              <label className="block corporate-form-label mb-2">Açıklama</label>
      ...
      >
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="corporate-table-header p-4 rounded">
                <label className="block corporate-form-label mb-1">Sistem Sürümü</label>
                <p className="text-lg font-semibold">{systemInfo.version}</p>
              </div>
              <div className="corporate-table-header p-4 rounded">
                <label className="block corporate-form-label mb-1">Yapı Tarihi</label>
                <p className="text-lg font-semibold">{systemInfo.buildDate}</p>
              </div>
              <div className="corporate-table-header p-4 rounded">
                <label className="block corporate-form-label mb-1">Ortam</label>
                <p className="text-lg font-semibold">{systemInfo.environment}</p>
              </div>
              <div className="corporate-table-header p-4 rounded">
                <label className="block corporate-form-label mb-1">Çalışma Süresi</label>
          ...
          <div>
            ...
            <div className="corporate-table-header p-4 rounded">
              ...
              <div className="mt-4 corporate-form-group">
