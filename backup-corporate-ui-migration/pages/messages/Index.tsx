    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-4 rounded-lg border space-y-4">
        ...
        <div className="flex items-center gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-2 corporate-table-header px-3 py-2 rounded-lg">
        ...
        {selectedMessage && (
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block corporate-form-label mb-1">Konu</label>
              ...
              <div>
                <label className="block corporate-form-label mb-1">Gönderen</label>
              ...
              <div>
                <label className="block corporate-form-label mb-1">Tür</label>
              ...
              <div>
                <label className="block corporate-form-label mb-1">Tarih</label>
                <p className="text-sm text-gray-900">{selectedMessage.date} {selectedMessage.time}</p>
              </div>
              {selectedMessage.group && (
                <div>
                  <label className="block corporate-form-label mb-1">Grup</label>
      ...
      >
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block corporate-form-label mb-1">Mesaj Türü</label>
          ...
          <div>
            <label className="block corporate-form-label mb-1">Mesaj İçeriği</label>
            <textarea
              rows={4}
              className="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
