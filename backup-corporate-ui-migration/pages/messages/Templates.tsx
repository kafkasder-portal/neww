    ...
    <div className="space-y-6">
        ...
        {selectedTemplate && (
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block corporate-form-label mb-1">Şablon Adı</label>
                <p className="text-sm text-gray-900">{selectedTemplate.name}</p>
              </div>
              <div>
                <label className="block corporate-form-label mb-1">Kategori</label>
              ...
              <div>
                <label className="block corporate-form-label mb-1">Kullanım Sayısı</label>
                <p className="text-sm text-gray-900">{selectedTemplate.usageCount || 0}</p>
              </div>
              <div>
                <label className="block corporate-form-label mb-1">Oluşturulma Tarihi</label>
                <p className="text-sm text-gray-900">{selectedTemplate.createdAt}</p>
              </div>
              <div>
                <label className="block corporate-form-label mb-1">Favori</label>
            ...
            <div>
              <label className="block corporate-form-label mb-2">İçerik</label>
              <div className="corporate-table-header p-3 rounded border">
      ...
      >
        <div className="space-y-4">
            ...
            <div>
              <label className="flex items-center gap-2">
                <input
                  ...
                  className="rounded"
                />
                <span className="corporate-form-label">Favori olarak işaretle</span>
              </label>
            </div>
          </div>
          ...
          <div>
            <label className="block corporate-form-label mb-1">İçerik</label>
            <textarea
