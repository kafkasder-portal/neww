        ...
        {selectedDelivery && (
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block corporate-form-label mb-1">SMS ID</label>
              ...
              <div>
                <label className="block corporate-form-label mb-1">Telefon</label>
                <p className="text-sm text-gray-900">{selectedDelivery.phone}</p>
              </div>
              <div>
                <label className="block corporate-form-label mb-1">Operatör</label>
                <p className="text-sm text-gray-900">{selectedDelivery.provider}</p>
              </div>
              <div>
                <label className="block corporate-form-label mb-1">Maliyet</label>
              ...
              <div>
                <label className="block corporate-form-label mb-1">Mesaj Uzunluğu</label>
            ...
            <div>
              <label className="block corporate-form-label mb-2">Mesaj İçeriği</label>
          ...
          <div>
            ...
            <div className="space-y-3">
              {providers.map(provider => {
                ...
                return (
                  <div key={provider} className="flex items-center justify-between p-3 corporate-table-header rounded">
                    <div>
