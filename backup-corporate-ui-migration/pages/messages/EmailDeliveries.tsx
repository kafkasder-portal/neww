    ...
    },
    {
      ...
      render: (_, delivery) => (
        <div className="flex items-center gap-1">
          ...
          <button
            className="p-1 text-gray-600 hover:corporate-table-header rounded"
            title="Arşivle"
          >
      ...
      <div className="bg-white p-4 rounded-lg border space-y-4">
        ...
        <div className="flex items-center gap-4 flex-wrap">
          <div className="flex items-center gap-2">
            ...
            <span className="corporate-form-label">Filtreler:</span>
          </div>
        ...
        {selectedDelivery && (
          <div className="space-y-6">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block corporate-form-label mb-1">E-posta ID</label>
                <p className="text-sm text-gray-900 font-mono">{selectedDelivery.id}</p>
              </div>
              <div>
                <label className="block corporate-form-label mb-1">Durum</label>
                <div className="flex items-center gap-2">
            ...
            <div>
              <label className="block corporate-form-label mb-2">Konu</label>
              <div className="corporate-table-header p-3 rounded border">
                <p className="text-sm text-gray-900 font-medium">{selectedDelivery.subject}</p>
              </div>
            </div>
            
            <div>
              <label className="block corporate-form-label mb-2">E-posta İçeriği</label>
              <div className="corporate-table-header p-3 rounded border max-h-64 overflow-y-auto">
            ...
            {selectedDelivery.hasAttachments && (
              <div>
                <label className="block corporate-form-label mb-2">Ekler</label>
            ...
            {selectedDelivery.failureReason && (
              <div>
                <label className="block corporate-form-label mb-2">Hata Nedeni</label>
            ...
            <div className="flex justify-end gap-2 pt-4">
              ...
              <button
                ...
                className="px-4 py-2 text-gray-600 border border-gray-300 rounded-lg hover:corporate-table-header transition-colors"
              >
                Kapat
              </button>
            </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              {[
                ...
                return (
                  <div key={item.status} className="flex items-center justify-between p-3 corporate-table-header rounded">
          ...
          <div>
            ...
            <div className="space-y-3">
              {['urgent', 'high', 'normal', 'low'].map(priority => {
                ...
                return (
                  <div key={priority} className="flex items-center justify-between p-3 corporate-table-header rounded">
                    <div>
