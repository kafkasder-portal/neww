              ...
              <button
                ...
                className={`px-4 py-2 text-sm ${
                  activeTab === 'periods' 
                    ...
                    : 'bg-white text-gray-700 hover:corporate-table-header'
                }`}
              >
                Dönemler
              </button>
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
              ...
              <button
                ...
                className="corporate-btn-success"
              >
                Excel İndir
              </button>
            </div>
              ...
              <div className="bg-white border rounded p-4">
                ...
                <div className="corporate-form-group">
                  {selectedPeriod.campaigns.map((campaign, index) => (
                    <div key={index} className="text-sm p-2 corporate-table-header rounded">{campaign}</div>
                  ))}
                </div>
              </div>
              <div className="bg-white border rounded p-4">
                ...
                <div className="corporate-form-group">
                  {selectedPeriod.specialPrograms.map((program, index) => (
                    <div key={index} className="text-sm p-2 corporate-table-header rounded">{program}</div>
                  ))}
                </div>
              </div>
            </div>
