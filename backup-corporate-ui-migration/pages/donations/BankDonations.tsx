    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="corporate-btn-success flex items-center gap-2"
            >
              <FileText size={16} />
              CSV İndir
            </button>
            <button
              ...
              className="corporate-btn-primary flex items-center gap-2"
            >
            ...
            <button
              ...
              className="corporate-btn-danger flex items-center gap-2"
            >
              <FileText size={16} />
              PDF İndir
            </button>
      ...
      >
        <form onSubmit={handleMatchSubmit} className="space-y-4">
          <div className="corporate-table-header p-4 rounded-lg mb-4">
