        ...
        <div className="bg-gradient-to-br from-gray-50 to-slate-50 border border-gray-200 rounded-xl p-6 mb-8 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="corporate-form-group">
              <label className="corporate-form-label">İşlem Türü</label>
              <select
            ...
            <div className="corporate-form-group">
              <label className="corporate-form-label">Tutar (₺)</label>
              <input
                type="number"
                placeholder="0.00"
            ...
            <div className="corporate-form-group">
              <label className="corporate-form-label">Açıklama</label>
              <input
                type="text"
            ...
            <div className="corporate-form-group">
              <label className="corporate-form-label">&nbsp;</label>
