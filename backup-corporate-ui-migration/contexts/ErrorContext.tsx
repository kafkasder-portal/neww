...
export class ErrorBoundary extends React.Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  render() {
    if (this.state.hasError && this.state.error) {
      ...
      return (
        <div className="min-h-screen flex items-center justify-center corporate-table-header">
            ...
            <div className="mt-4 text-center">
              ...
              <div className="mt-4 corporate-form-group">
                ...
                <button
                  ...
                  className="w-full inline-flex justify-center px-4 py-2 corporate-form-label bg-white border border-gray-300 rounded-md hover:corporate-table-header focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                >
                  Sayfayı Yenile
                </button>
              </div>
