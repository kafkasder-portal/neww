-- Fixed seed data for development and testing
-- This migration adds sample data with correct column names
...
-- Sample meeting data (using correct column names: start_time, end_time, created_by)
INSERT INTO meetings (id, title, description, start_time, end_time, location, meeting_type, status, created_by) VALUES
(
...
-- Set meeting_url for online meeting
UPDATE meetings 
SET meeting_url = 'https://meet.google.com/abc-defg-hij'
WHERE id = '55555555-5555-5555-5555-555555555555';

-- Sample agenda items
INSERT INTO meeting_agenda (meeting_id, title, description, duration_minutes, order_index) VALUES
...
-- Sample task activities (using correct column names: activity_type, description, old_value, new_value)
INSERT INTO task_activities (task_id, user_id, activity_type, description) VALUES
('77777777-7777-7777-7777-777777777777', '00000000-0000-0000-0000-000000000000', 'created', 'Görev oluşturuldu'),
('77777777-7777-7777-7777-777777777777', '00000000-0000-0000-0000-000000000000', 'status_changed', 'Görev durumu güncellendi'),
('88888888-8888-8888-8888-888888888888', '00000000-0000-0000-0000-000000000000', 'created', 'Görev oluşturuldu'),
('99999999-9999-9999-9999-999999999999', '00000000-0000-0000-0000-000000000000', 'created', 'Görev oluşturuldu'),
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '00000000-0000-0000-0000-000000000000', 'created', 'Acil görev oluşturuldu'),
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '00000000-0000-0000-0000-000000000000', 'due_date_changed', 'Görev son tarihi güncellendi')
ON CONFLICT DO NOTHING;

-- Update task activities with old_value and new_value for status changes
UPDATE task_activities 
SET old_value = 'pending', new_value = 'in_progress'
WHERE task_id = '77777777-7777-7777-7777-777777777777' AND activity_type = 'status_changed';

UPDATE task_activities 
SET old_value = 'high', new_value = 'urgent'
WHERE task_id = 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa' AND activity_type = 'due_date_changed';
...
-- Sample meeting action items (including required created_by column)
INSERT INTO meeting_action_items (meeting_id, title, description, assigned_to, due_date, status, created_by) VALUES
('44444444-4444-4444-4444-444444444444', 'Haftalık rapor hazırlama', 'Geçen haftaki çalışmaların özetlenmesi', '00000000-0000-0000-0000-000000000000', '2024-12-03', 'pending', '00000000-0000-0000-0000-000000000000'),
('44444444-4444-4444-4444-444444444444', 'Kod review sürecinin iyileştirilmesi', 'Mevcut kod review sürecinin gözden geçirilmesi ve iyileştirilmesi', '00000000-0000-0000-0000-000000000000', '2024-12-06', 'pending', '00000000-0000-0000-0000-000000000000'),
('55555555-5555-5555-5555-555555555555', 'Q4 raporu finalizasyonu', 'Proje sonuçları raporunun tamamlanması', '00000000-0000-0000-0000-000000000000', '2024-12-08', 'pending', '00000000-0000-0000-0000-000000000000')
ON CONFLICT DO NOTHING;
