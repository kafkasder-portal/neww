    ...
    if (this.state.hasError && this.state.error) {
      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50">
          <div className="max-w-md w-full bg-white shadow-lg rounded-lg p-6 bg-card rounded-lg border">
            ...
            <div className="mt-4 text-center">
              ...
              <div className="mt-4 space-y-6-group">
                ...
                <button
                  ...
                  className="w-full inline-flex justify-center px-4 py-2 space-y-6-label bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                >
                  Sayfayı Yenile
                </button>
              </div>
