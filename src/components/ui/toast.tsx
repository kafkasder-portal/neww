    ...
    ],
    {
        variants: {
            variant: {
                ...
                warning:
                    "border-orange-500/50 bg-orange-50 text-orange-700 dark:bg-orange-900/20 dark:text-orange-400",
                info:
                    "border-blue-500/50 bg-blue-50 text-blue-700 dark:bg-blue-900/20 dark:text-blue-400",
            },
        },
        defaultVariants: {
            variant: "default",
...
>(({ className, variant = "default", icon, showIcon = true, children, ...props }, ref) => {
    ...
    return (
        <Toast ref={ref} className={cn("pl-12", className)} variant={variant} {...props}>
            {showIcon && displayIcon && (
                <div className="absolute left-4 top-4 flex h-6 w-6 items-center justify-center">
                    {displayIcon}
                </div>
            )}
            {children}
...
export {
    Toast, ToastAction, ToastClose, ToastDescription, ToastProvider, ToastTitle, toastVariants, ToastViewport, ToastWithIcon, type ToastActionElement, type ToastProps
}
