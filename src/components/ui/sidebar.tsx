...
>(
  (
    { variant = "sidebar", collapsible = "offcanvas", className, children, ...props },
    ref
  ) => {
    ...
    if (isMobile) {
      return (
        <div
          ...
          className={cn(
            "fixed inset-y-0 left-0 z-50 h-svh w-[--sidebar-width-mobile] bg-sidebar text-sidebar-foreground transition-[left] duration-200 ease-in-out",
    ...
    return (
      <div
        ...
        className={cn(
          ...
          "duration-200 ease-in-out data-[collapsible=icon]:transition-[width]",
          {
            "w-[--sidebar-width] data-[state=collapsed]:w-[--sidebar-width-icon]":
              collapsible === "icon",
            "w-[--sidebar-width]": collapsible === "offcanvas",
          },
          className
        )}
        {...props}
...
>(({ className, ...props }, ref) => {
  return (
    <input
      ...
      data-sidebar="input"
      className={cn(
        "flex h-8 w-full rounded-md bg-background px-3 py-1 text-sm shadow-none transition-colors file:border-0 file:bg-transparent file:text-foreground file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:cursor-not-allowed disabled:opacity-50",
        className
      )}
      {...props}
    />
...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="h-4 max-w-[--skeleton-width] flex-1 bg-sidebar-accent-foreground/20 rounded-sm"
        style={
          {
