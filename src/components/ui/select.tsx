...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "hover:border-input/80 focus:border-primary/50 focus:shadow-sm",
      "data-[error=true]:border-destructive data-[error=true]:focus:ring-destructive",
      "data-[success=true]:border-green-500 data-[success=true]:focus:ring-green-500",
      className
    )}
    {...props}
  >
