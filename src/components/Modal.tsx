...
export function Modal({ 
  ...
  return (
    ...
    >
      ...
      <div 
        ref={modalRef}
        className={`relative z-10 w-full rounded-xl border-0 bg-white shadow-2xl transform transition-all duration-300 scale-100 ${
          size === 'small' ? 'max-w-md' :
        ...
        {title && (
          <div className="border-b border-border/10 px-6 py-4 bg-gradient-to-r from-sidebar-primary/5 to-primary/5 rounded-t-xl">
            <div className="flex items-center justify-between">
              <h2 id="modal-title" className="text-lg font-semibold text-foreground font-['Poppins']">{title}</h2>
              <button
                onClick={onClose}
