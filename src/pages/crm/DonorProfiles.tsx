  ...
  const columns: Column<Donor>[] = [
    {
      ...
      render: (donor) => (
        <input
          type="checkbox"
          className="space-y-6-checkbox rounded text-bg-primary"
    ...
    <CorporateCard>
      ...
      <CorporateCardContent>
          ...
          <div className="p-4 mb-4 border rounded-lg bg-muted">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <FormGroup>
                ...
                <select className="space-y-6-select" onChange={(e) => handleFilterChange('status', e.target.value)}>
              ...
              <FormGroup>
                ...
                <select className="space-y-6-select" onChange={(e) => handleFilterChange('donorTier', e.target.value)}>
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            <select 
              className="space-y-6-select text-sm"
              value={bulkAction}
      ...
      <CorporateModal isOpen={showAddModal} onClose={() => setShowAddModal(false)}>
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50-header">
          <h2 className="text-lg font-semibold text-foreground">Yeni Bağışçı Ekle</h2>
        </div>
      ...
      <CorporateModal isOpen={showEditModal} onClose={() => setShowEditModal(false)}>
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50-header">
          <h2 className="text-lg font-semibold text-foreground">Bağışçı Düzenle</h2>
        </div>
        <div className="p-6 bg-card rounded-lg border">
      ...
      <CorporateModal isOpen={showImportModal} onClose={() => setShowImportModal(false)}>
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50-header">
          <h2 className="text-lg font-semibold text-foreground">Bağışçıları İçe Aktar</h2>
        </div>
        <div className="p-6 bg-card rounded-lg border">
